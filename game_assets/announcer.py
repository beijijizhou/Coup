from .in_game_type import CharacterActions, ActionType
...
class Announcer():
    ...
    def _show_character_actions(self):
        for character in CharacterActions:
    ...
    def handle_boardcast_action_event(self, data):
        ...
        #                 f"{data.player_action_type}: {CharacterActions[data.player_action_type].value}\n"
        #             )
